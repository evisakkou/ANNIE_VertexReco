...
infile= 'predictionsVertex_20hits.csv'
...
f1=ax.hist(dataprev, nbins, histtype='step', fill=False, color='red',alpha=0.75, label='DR_Reco')
#ax.set_xlim(0.,200.)
...
plt.show()
fig.savefig('resol_DR_20hits.png')
plt.close(fig)
