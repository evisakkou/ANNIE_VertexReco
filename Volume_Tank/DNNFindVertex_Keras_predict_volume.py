...
infile='shuffledtankPMT_forVetrexReco_final.csv'
...
features, nhits, rest2, recovertex, labels, gridpoint, gridpointreco = np.split(Dataset,[4400,4401,4402,4405,4408,4409],axis=1)
...
# print(df_final.head())
df_f.to_csv("predictionsVertexDR.csv", float_format = '%.3f', index=False)
df_final.to_csv("Finalprediction.csv", float_format = '%.3f', index=False)
